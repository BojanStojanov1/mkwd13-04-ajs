...
let navigationMenuService = {
    navigationLinks : document.getElementsByClassName("nav-item"),
...
let uiService = {
    ...
    loadHourlyData: function(data){
        ...
        data.list.forEach(item => {
            ...
            <div class='col-sm-2'>${helperService.getDateFromSeconds(item.dt).toUTCString()}</div>
            <div class='col-sm-2'>${helperService.item.main.temp.toFixed(2)} C</div>
