...
## Exercise 1
Create 3 classes: Academy, Student and Subject. The structure should be:
...
> ### NOTE: "Not settable" means it should not be added to the parameters list of the constructor
